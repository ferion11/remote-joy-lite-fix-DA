...
//	LOG("_UsbResetDevice()", getLastError());
//
//	devInfo = SetupDiGetClassDevs(NULL, 0, 0, DIGCF_PRESENT | DIGCF_ALLCLASSES);
//	if (devInfo == INVALID_HANDLE_VALUE) {
//		LOG("_UsbResetDevice(): SetupDiGetClassDevsEx(){reason=\"%s\"}", getLastError());
//		return;
//	}
//
...
//			LOG("_UsbResetDevice(): SetupDiGetDeviceRegistryProperty(){reason=\"%s\"}", getLastError());
//			continue;
//        }
//
...
//		}
//
//		LOG("_UsbResetDevice(): found{hardwareId=\"%s\"}", hardwareId);
//
...
//			LOG("_UsbResetDevice(): SetupDiSetClassInstallParams(){reason=\"%s\"}", getLastError());
//			return;
//		}
//		
//		if (!SetupDiCallClassInstaller(DIF_PROPERTYCHANGE, devInfo, &devInfoData)) {
//			LOG("_UsbResetDevice(): SetupDiCallClassInstaller(){reason=\"%s\"}", getLastError());
//			return;
//        }
//
//		LOG("_UsbResetDevice(): The device was reset.");
//	}
//}
//
